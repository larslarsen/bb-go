...
[BBGO-SEC-002](../../tickets/BBGO-SEC-002.md) is authorized to retire the inherited
marketplace/payment `qa/` tree that owns all four current Dependabot alerts. Its full
source and integration prompts are preserved in
