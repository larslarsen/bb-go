...
fluctuations. This functionality is provided by the a package implementing the [ExchangeRates](https://github.com/larslarsen/bb-go/blob/master/bitcoin/exchangerates.go) interface.
