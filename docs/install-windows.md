...
- Install `openbazaar-go`:
    + Open the command prompt and run: `go get github.com/larslarsen/bb-go`. This will use git to checkout the source code into `%GOPATH%\src\github.com\OpenBazaar\openbazaar-go`.
