...
Example:
Windows: `go run bitbookd.go init -d=c://path/to/data/directory`
Linux/MacOS: `go run bitbookd.go init -d=/path/to/data/directory`
...
Example:
Windows: `go run bitbookd.go start -d=c://path/to/data/directory`
Linux/MacOS: `go run bitbookd.go start -d=/path/to/data/directory`
