...
```
Usage:
  bitbookd [OPTIONS] start [start-OPTIONS]
...
[start command options]
      ...
      -v, --verbose               print bitbook logs to stdout
...
Contributions are definitely welcome! Please read the Contributing [Guidelines](https://github.com/larslarsen/bb-go/blob/master/CONTRIBUTING.md) before starting.

## License
[MIT](https://github.com/larslarsen/bb-go/blob/master/LICENSE).
